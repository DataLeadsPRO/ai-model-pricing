...
- **Remote (Streamable HTTP):** `https://data.dataleads.pro/mcp/ai-model-pricing`
- **Stdio (Docker):** `docker run -e DATALEADS_API_KEY=yourkey ghcr.io/dataleads/ai-model-pricing-mcp:latest`
